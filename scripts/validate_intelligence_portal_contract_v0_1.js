...
assert("ecommerce dictionary keeps Fashion as independent L1", fashionDictionaryRows.length >= 7 && fashionDictionaryRows.every((x) => x.standard_l1 === "Fashion"), `got ${fashionDictionaryRows.length}`);
